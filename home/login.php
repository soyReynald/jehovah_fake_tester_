...
<head>
    ...
    <title>Formulary to login to the pharmacy</title>
    <!-- The stability is not sufficient to work locally -->
    <script src="https://cdn.tailwindcss.com"></script>
</head>

<body>
    <!-- Anyone who is from the truth ... - Jesus. -->
    <!--
  ...
  <body class="h-full">
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form action="private_includes/login.php" method="POST" class="space-y-6">
                <div>
